...
window.optimizedResize=function(){var n=[],i=!1;function e(){i||(i=!0,window.requestAnimationFrame?window.requestAnimationFrame(t):setTimeout(t,66))}function t(){n.forEach(function(n){n()}),i=!1}return{add:function(i){n.length||window.addEventListener("resize",e),(t=i)&&n.push(t);var t}}}(),window.optimizedScroll=function(){var n=[],i=!1;function e(){i||(i=!0,window.requestAnimationFrame?window.requestAnimationFrame(t):setTimeout(t,66))}function t(){n.forEach(function(n){n()}),i=!1}return{add:function(i){n.length||window.addEventListener("scroll",e),(t=i)&&n.push(t);var t}}}();
!function(e){var o,t,n,a,l,s=-1;if("-ms-user-select"in document.documentElement.style&&navigator.userAgent.match(/IEMobile\/10\.0/)){var i=document.createElement("style");i.appendChild(document.createTextNode("@-ms-viewport{width:auto!important}")),document.getElementsByTagName("head")[0].appendChild(i)}var d=function(e){var l=document.getElementById("gmap").getAttribute("data-maxZoom"),s=document.getElementById("gmap").getAttribute("data-minZoom"),i=document.getElementById("gmap").getAttribute("data-styles");n=new google.maps.Map(document.getElementById("gmap"),{center:{lat:-34.397,lng:150.644},disableDoubleClickZoom:!0,draggable:!1,mapTypeControl:!1,scrollwheel:!1,styles:i||[],minZoom:s||1,maxZoom:l||18}),o=new google.maps.LatLngBounds,t=new google.maps.InfoWindow;for(var d=[],m=0;m<e.length;m++){var r=new google.maps.LatLng(e[m].lat,e[m].lng);o.extend(r),a=new google.maps.Marker({icon:e[m].marker,position:r,map:n}),n.fitBounds(o),d.push(e[m].address),google.maps.event.addListener(a,"click",(c=a,g=m,function(){t.setContent(d[g]),t.open(n,c)})),google.maps.event.addListener(a,"closeclick",function(){n.fitBounds(o)})}var c,g;google.maps.event.addDomListener(window,"resize",function(){n.fitBounds(o)})},m=function(){var o=window.pageYOffset;s!=o&&(s=o,0<o?e("body").addClass("scrolled"):e("body").removeClass("scrolled"))};e(document).ready(function(){e("body").hasClass("nav-custom")||(e("body").on("click",".menu-item-has-children a",function(o){var t=/#/.test(this.href),n=e(this).parentsUntil("ul");t&&(o.preventDefault(),e(n).toggleClass("menu-item-open")),n.siblings(".menu-item-has-children").not(e(n)).removeClass("menu-item-open")}),e("body").on("click",".ocn-sub-menu-button",function(o){var t=e(this).parentsUntil("ul");console.log(t),e(t).toggleClass("menu-item-open"),t.siblings(".menu-item-has-children").not(e(t)).removeClass("menu-item-open")}),e("body").hasClass("nav-ocn")&&e('<a href="javascript:void(0)" class="nav-toggle" id="ocn-overlay"></a>').appendTo("body"),e("body").on("click",".nav-toggle",function(o){o.preventDefault(),e("body").toggleClass("nav-open")})),m(),document.getElementById("gmap")&&(l=JSON.parse(MSWObject.google_map_data),d(l)),1==MSWObject.show_dashboard_link&&e('<a href="'+MSWObject.home_url+'/wp-admin" id="msw-dashboard" title="Dashboard" rel="nofollow" target="_blank"><img src="'+MSWObject.site_url+'/wp-admin/images/w-logo-white.png" height="24" width="24" alt="Dashboard"></a>').appendTo("body"),e(".filter-dropdown").on("click",function(o){o.stopPropagation(),e(this).toggleClass("active"),e(".filter-dropdown").not(this).removeClass("active")}),e(document).on("click.closefilter",":not(.filter-dropdown)",function(){e(".filter-dropdown").removeClass("active")}),optimizedScroll.add(m)})}(jQuery);
!function(e){var t;e(document).ready(function(){e(".buyer-guide-form").length&&e(".buyer-guide-form").attr("href",MSWObject.buyer_guide_form),e(".key-features").length&&e(".key-features").slick({arrows:!0,dots:!1,autoplay:!0,autoplaySpeed:5e3,cssEase:"linear",pauseOnHover:!1,nextArrow:'<button type="button" class="next-arrow"><i class="fa fa-angle-right"></i></button>',prevArrow:'<button type="button" class="prev-arrow"><i class="fa fa-angle-left"></i></button>'}),e(".magnific-video").length&&e(".magnific-video").magnificPopup({type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1}),e(".testimonies").length&&e(".testimonies").slick({arrows:!0,dots:!0,cssEase:"linear",fade:!0,nextArrow:'<button type="button" class="next-arrow"><i class="fa fa-angle-right"></i></button>',prevArrow:'<button type="button" class="prev-arrow"><i class="fa fa-angle-left"></i></button>'}),function(){if(e("#cd-map").length){var o=document.getElementById("cd-map"),l=MSWObject.points,a={lat:parseFloat(l[0][2]),lng:parseFloat(l[0][3])};t=new google.maps.Map(o,{disableDoubleClickZoom:!0,draggable:!1,mapTypeControl:!1,scrollwheel:!1,center:a,zoom:11,streetViewControl:!1,styles:[{elementType:"geometry",stylers:[{color:"#f5f5f5"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f5f5"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#ffffff"}]},{featureType:"road.arterial",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#dadada"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#c9c9c9"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]}]}),bounds=new google.maps.LatLngBounds,infoWindow=new google.maps.InfoWindow;for(var r=[],n=0;n<l.length;n++){var s=new google.maps.Marker({position:new google.maps.LatLng(parseFloat(l[n][2]),parseFloat(l[n][3])),icon:MSWObject.marker_url,map:t});r.push(l[n][1]),google.maps.event.addListener(s,"click",(i=s,m=n,function(){t.setCenter(i.position),infoWindow.setContent(r[m]),infoWindow.open(t,i)})),google.maps.event.addListener(s,"closeclick",function(){t.fitBounds(bounds)}),google.maps.event.addDomListener(window,"resize",function(){t.fitBounds(bounds),t.setCenter(a)})}var i,m;google.maps.event.addDomListener(window,"resize",function(){t.fitBounds(bounds),t.setCenter(a)})}}(),e(".mega-menu").length&&e(".mega-menu-list").length&&(e(".mega-menu").addClass("menu-item-has-children"),e(".mega-menu").append(e(".mega-menu-list").remove()),e(".mega-menu").show()),e(".menu-item-has-children.trigger > a, .menu-item-has-children.trigger > .ocn-link-wrap > a").on("click",function(e){e.preventDefault()}),function(){if(location.hash.length&&e(location.hash).length){window.scrollTo(0,1);var t=e(location.hash).offset().top-e(".site-header").outerHeight();e("html, body").animate({scrollTop:t},800)}}(),console.log("fn"),e(".gform_confirmation_wrapper").length&&(console.log("conf"),e("html, body").animate({scrollTop:e(".gform_confirmation_wrapper").offset().top-e(".site-header").outerHeight()-100},800)),function(){var t=document.getElementById("home-hero-video");"0"!==localStorage.getItem("interstitial")||e("#interstitial").hasClass("vis")||t.play(),e("#interstitial").length&&(null!==localStorage.getItem("interstitial")&&"1"!==localStorage.getItem("interstitial")||(e("body").addClass("interstitial"),e("#interstitial").addClass("vis"),localStorage.setItem("interstitial","1"))),e(".close-interstitial").on("click",function(o){o.preventDefault(),e("body").removeClass("interstitial"),e("#interstitial").removeClass("vis"),localStorage.setItem("interstitial","0"),t.play()})}()})}(jQuery);