<?php
    ...
    if (isset($_GET['continue']) && $_GET['continue'] == 'yes' && !TableExists('sessions', $DB)) {
        ...
        $pass = $DB->real_escape_string(crypt('admin', $salt));
...
<body style="overflow:auto;">
    <nav id="app-navbar" class="navbar" role="navigation">
        ...
        <div class="btn-group navbar-right">
            <a href="index.html" tabindex="1" type="button" class="btn icon-library"
                title="{{strings.view_library}} [{{keyboard.SwitchToLibrary}}]" aria-label="{{strings.view_library}}">
    ...
    ?>
        ...
        <div class="container">
            ...
            ?>
                ...
                <p>The installation is finished! You can now use the Embellisher App and the <a href="admin/"
                        target="_blank">admin interface</a><br />
