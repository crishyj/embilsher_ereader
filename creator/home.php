        ...
        <div class="col-md-4 jumbotron" style="font-size:100%;">
            <form role="form" action="creator.php" id="formnew" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="booktitle">Book Title</label><input type="text" name="booktitle" class="form-control"
                        id="booktitle" required="required">
                </div>
                <div class="form-group">
                    <label for="booktitle">Author</label><input type="text" name="author" class="form-control"
                        id="author" required="required">
                </div>
                <div class="form-group">
                    <label for="lang">Language (2 letter code)</label><input type="text" name="lang"
                        class="form-control" id="author" required="required" value="en">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="coverimage">Cover Image (optional)</label><input type="file" title="Browse cover image"
                ...
                <div class="form-group">
                    ...
                    <select id="template" class="ddslick">
                        <option value="0" data-imagesrc="images/templates/0.png" data-description="Start from scratch.">
                            Empty</option>
                        <?php
                        ...
                        <option value="2" data-imagesrc="images/templates/2.jpg" data-description="Children books">
                            Children</option>
                        <option value="3" data-imagesrc="images/templates/3.jpg" data-description="Medieval books">
                            Medieval</option>
                        <?php
                            }
                             ?>
                ...
                <button type="submit" name="create" value="new" class="btn btn-primary"><span
                        class="glyphicon glyphicon-plus"></span> Create new Ebook</button>
            </form>
        </div>
